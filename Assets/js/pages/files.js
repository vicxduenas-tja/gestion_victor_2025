...
// compartir archivos enttre usuarios
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    carpetas.forEach(carpeta => {
        carpeta.addEventListener('click', function (e) {
            ...
            myModal2.show();   //el modal ver,subir archivo y compartir
        });
    });
    ...
    //ver detalle de archivos compartidos
    ...
    eliminar.forEach(enlace => {
        enlace.addEventListener('click', function (e) {
            ...
            eliminarRegistro('¿Está seguro de eliminar el archivo?', 'El archivo se eliminara de forma permanente en 30 dias', 'si eliminar', url, null);
        });
    });
    ...
    http.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            if (res.length > 0) {
                ...
                res.forEach(archivo => {  //estos son los cheks
